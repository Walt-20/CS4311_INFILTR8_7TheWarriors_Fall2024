...
<<<<<<<< HEAD:python-backend/venv/lib/python3.11/site-packages/pip/_vendor/cachecontrol/adapter.py
                response._fp = CallbackFileWrapper(
                    response._fp,
========
                response._fp = CallbackFileWrapper(  # type: ignore[attr-defined]
                    response._fp,  # type: ignore[attr-defined]
>>>>>>>> 438112f5b619340558d85b5f37e25199ba800d0d:python-backend/venv/lib/python3.12/site-packages/pip/_vendor/cachecontrol/adapter.py
                    functools.partial(
                        self.controller.cache_response, request, response
                    ),
                )
